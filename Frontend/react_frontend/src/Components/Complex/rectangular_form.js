...
const RectangularForm = () => {
    ...
    if (input_data.data) {
        try {
            result = nerdamer(`rectform(${input_data.data})`).toString()
        }
        catch {
        ...
        <div className="container-sm">
            <div className="row">
                <div className=" col-sm-12">
                    <input id='data' onChange={expression_onchange_handler} placeholder="Enter the imaginary number in polar form" className="navbar col-sm-12 rounded fs-3 bg-dark text-light"></input>
                </div>
